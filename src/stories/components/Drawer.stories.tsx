...
export const AccountDetail: Story = {
  ...
  render: () => (
    <div style={{ position: "relative", height: "640px", background: "var(--color-canvas)", fontFamily: "var(--font-sans)" }}>
      <div className="drawer-overlay" style={{ position: "absolute" }} />
      <div className="drawer" style={{ position: "absolute" }} role="dialog" aria-modal="true" data-testid="detail-drawer">
        <div className="drawer__header">
          <div>
            <p className="drawer__eyebrow">Account</p>
            <h2 className="drawer__title">Orion Health</h2>
          </div>
          <button className="icon-btn" aria-label="Close" data-testid="drawer-close">
            <CloseIcon />
          </button>
        </div>
